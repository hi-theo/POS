...
<center><h1>PROFIT INCOME </h1></center><br/>
<?php 
    $b=$jml->row_array();
?>
<table class="table">
<thead>
<tr>
<th colspan="11" style="text-align:left;"><?php echo $b['bulan'];?></th>
</tr>
    <tr class="bg-light">
...
<tfoot>
    ...
    <tr>
        <td colspan="8" style="text-align:right;"><h4><b>Total Profit</b></h4></td>
